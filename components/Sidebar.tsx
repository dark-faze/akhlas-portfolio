...
const Sidebar = () => {
    ...
    return (
        <div>
            ...
            <p className = "px-2 py-1 my-3 bg-gray-200 rounded-full ">Aspiring Software developer</p>
            <a className = "px-2 py-1 my-3 bg-gray-200 rounded-full flex item-center justify-center" href="/resume.pdf" download = "resume.pdf">
            ...
            <div className = 'my-5 py-4 bg-gray-200 dark:text-white dark:bg-dark-200' style={{marginLeft:'-1rem',marginRight:'-1rem'}}>
                ...
                <p className='my-2'>akhlashussain3@gmail.com</p>
                <p className='my-2'>7990918384</p>
            </div>
            <button className="bg-gradient-to-r from-mauve-a to-mauve-b w-8/12 rounded-full py-2 px-5 text-white bg-black my-2 focus:outline-none" 
             onClick={()=>window.open('mailto:akhlashussain3@gmail.com')} >
                 Email Me</button>
            <button onClick={changeTheme} className="bg-gradient-to-r from-mauve-a to-mauve-b w-8/12 rounded-full py-2 px-5 text-white my-2 ">Toggle Theme</button>
        </div>
    )
}
